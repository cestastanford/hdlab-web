...
- [What does it mean if I see a Lightning Bolt icon and ‘Special Characters Found’ in one of my dimensions?](##What does it mean if I see a Lightning Bolt icon and ‘Special Characters Found’ in one of my dimensions?)
- [What is a Multiple Values Delimiter?](##What is a Multiple Values Delimiter?)
- [What are Size Points?](##What are Size Points?)
- [How do I get the most use out of the Timeline feature?](##How do I get the most use out of the Timeline feature?)
- [How should Dates be entered?](##How should Dates be entered?)
- [How should Coordinates be entered?](##How should Coordinates be entered?)
- [What do the labels and numbers listed directly below my dimension represent?](##What do the labels and numbers listed directly below my dimension represent?)
- [I would like to export a Map visualization but can only export it as an .svg with dots and lines. What should I do?](##I would like to export a Map visualization but can only export it as an .svg with dots and lines. What should I do?)
- [What are some applications of the Gallery View?](##What are some applications of the Gallery View?)
- [How do I get the most out of Map view?](##How do I get the most out of Map view?)
